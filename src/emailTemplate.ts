...
export function buildEmailTemplate(opts: EmailTemplateOptions): string {
  ...
  const footerExtraBlock = footerExtra
    ? `<tr><td style="padding:0 40px 8px;text-align:center;font-size:12px;color:#9ca3af;">${footerExtra}</td></tr>`
    : "";
...
<body style="margin:0;padding:0;background-color:#f3f4f6;" class="dm-bg">
  ...
  ${preheader ? `<div style="display:none;font-size:1px;color:#f3f4f6;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">${preheader}&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;</div>` : ""}
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-container" style="max-width:600px;">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:36px 40px 0;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;" class="dm-card">
              <h1 style="margin:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:26px;font-weight:700;color:#111827;line-height:1.3;letter-spacing:-0.5px;" class="dm-title">
                ${title}
              </h1>
          ...
          ${
            ctaBlock
              ...
              : `<tr><td style="background-color:#ffffff;height:24px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;" class="dm-card"></td></tr>`
          }
